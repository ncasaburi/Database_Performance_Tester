...
from src.menu.postgres.SubmenuPostgresTableCreate import SubmenuPostgresTableCreate
from src.menu.postgres.SubmenuPostgresTableDrop import SubmenuPostgresTableDrop
