...
from src.menu.mongo.Document.SubmenuMongoDocumentQuery import SubmenuMongoDocumentQuery
...
class SubmenuMongoDocument():
    ...
    def __init__(self) -> None:
        """This function initializes the SubmenuMongoDocument class"""
        ...
        mongo_document_query = SubmenuItem("Query documents", SubmenuMongoDocumentQuery().get(), self.submenu_mongo_document)
        ...
        self.submenu_mongo_document.append_item(mongo_document_query)
