...
from src.menu.postgres.SubmenuPostgresRowInsert import SubmenuPostgresRowInsert
from src.menu.postgres.SubmenuPostgresRowUpdate import SubmenuPostgresRowUpdate
from src.menu.postgres.SubmenuPostgresRowDelete import SubmenuPostgresRowDelete
