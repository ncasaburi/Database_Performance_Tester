...
class SubmenuPostgresRow():
    ...
    def __init__(self) -> None:
        ...
        postgres_row_update = SubmenuItem("Update rows", SubmenuPostgresRowInsert().get(), self.submenu_postgres_row)
        postgres_row_delete = SubmenuItem("Delete rows", SubmenuPostgresRowInsert().get(), self.submenu_postgres_row)
